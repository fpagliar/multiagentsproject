...
public class Tactic {
	...
	public boolean equals(final Object obj) {
		...
		return this.getStarAgents() == other.getStarAgents() && this.getHashtagAgents() == other.getHashtagAgents()
				&& this.getAmpersandAgents() == other.getAmpersandAgents() && this.strategy == other.strategy;
	}
	...
	private int getAmpersandAgents() {
		int ampersandCreatures = 0;
		for (Creature c : creatures) {
			if (c instanceof AmpersandCreature)
				ampersandCreatures++;
		}
		return ampersandCreatures;
	}
	...
	public String toString() {
		...
		ans.append(" AMPERSAND: ").append(getAmpersandAgents());
